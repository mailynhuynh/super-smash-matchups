                ...
                <div className="main-container stats">
                    ...
                    <div className="row">
                        ...
                        <div className="row stat-box">
                            ...
                            <div className="results">{slot1.spirits[0].primary}</div>
                            <div className="results">{slot2.spirits[0].primary}</div>
                        </div>
                        <div className="row stat-box">
                            <div className="name">Slot 1</div>
                            <div className="results">{slot1.spirits[1].slot_1}</div>
                            <div className="results">{slot2.spirits[1].slot_1}</div>
                        </div>
                        <div className="row stat-box">
                            <div className="name">Slot 2</div>
                            <div className="results">{slot1.spirits[2].slot_2}</div>
                            <div className="results">{slot2.spirits[2].slot_2}</div>
                        </div>
                        <div className="row stat-box">
                            <div className="name">Slot 3</div>
                            <div className="results">{slot1.spirits[3].slot_3}</div>
                            <div className="results">{slot2.spirits[3].slot_3}</div>
                        </div>
                    </div>
                    <div className="row">
                        ...
                        <div className="row stat-box">
                            ...
                            <div className="results">{slot1.unlock[0].wofl}</div>
                            <div className="results">{slot2.unlock[0].wofl}</div>
                        </div>
                        <div className="row stat-box">
                            <div className="name">Versus Mode</div>
                            <div className="results">{slot1.unlock[2].vs_mode}</div>
                            <div className="results">{slot2.unlock[2].vs_mode}</div>
                        </div>
                        <div className="row stat-box">
                            <div className="name">Classic Mode</div>
                            <div className="results">{slot1.unlock[1].classic_mode}</div>
                            <div className="results">{slot2.unlock[1].classic_mode}</div>
                        </div>
                    </div>
                    <div className="row">
